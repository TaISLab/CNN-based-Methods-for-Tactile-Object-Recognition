...
% -------------------------------------------------------------------------
% This script imports tactile data .csv files and converts them into images
% =========================================================================

function img = readFile(filename)
%% Import data from text file.
% Script for importing data from the 'filename' text file
%
%   ¡Don't forget to write the extension of the file!
% 
